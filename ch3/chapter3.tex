...
By applying the preprocessing code above from steps one and two, the dataset was reduced from its original 100,000 rows, representing security alerts, to approximately 86,000 rows.
