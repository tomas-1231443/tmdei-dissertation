...
This reflects their focus on minimizing the impact of cyber threats and enabling organizations to maintain operational continuity, artresilia2024.
...
\begin{enumerate}
    ...
    Implementing AI in security systems presents challenges like data integration, system compatibility, and performance maintenance under various conditions. This RQ aims to identify these challenges and suggest strategies for successful AI integration.
...
\begin{itemize}
    ...
    \item \textbf{Keywords:} False positives, false negatives, alert triage
...
To structure my literature review, I utilized two complementary frameworks: \textbf{PICOCS} and \textbf{snowballing}.
...
%     \begin{figure}[htp]
%         \centering
%         \includegraphics[width=\linewidth]{ch1/assets/WBS.png}
%         \caption{Work Breakdown Structure}
%         \label{fig:wbs-image}
%     \end{figure}
% \end{landscape}
